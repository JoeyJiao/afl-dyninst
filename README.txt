...
Dependency
----------
Ref to http://ele7enxxh.com/Use-AFL-dyninst-To-Fuzz-Blackbox-Binaries.html
apt install libtbb-dev libelf-dev libelf1 libiberty-dev libboost-all-dev
...
$ cd <PATH_TO_BINARY ex out/host/linux-x86/bin/>
